...
export APICLIpathexport=$APICLIpathbase/$primarytargetoutputformat

if [ ! -r $APICLIpathexport ] ; then
    mkdir $APICLIpathexport
fi

if [ "$primarytargetoutputformat" = "$FileExtJSON" ] ; then
...
# -------------------------------------------------------------------------------------------------
# MgmtCLILogin - Login to the API via mgmt_cli login
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# MgmtCLIPublish - publish changes if needed
# -------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------
# MgmtCLILogout - Logout from mgmt_cli, also cleanup session file
# -------------------------------------------------------------------------------------------------
...
if [ x"$script_use_export" = x"true" ] ; then
    if [ x"$CLIparm_exportpath" != x"" ] ; then
        ...
        export APICLICSVExportpathbase=./export
    fi
fi
...
if [ "$script_use_delete"=="true" ] ; then
    # primary operation is delete

    export APICLIpathexport=$APICLIpathbase/delete

    echo
    echo 'Delete using '$primarytargetoutputformat' Starting!'
    
elif [ "$script_use_import"=="true" ] ; then
    # primary operation is import

    export APICLIpathexport=$APICLIpathbase/import

    echo
    echo 'Import using '$primarytargetoutputformat' Starting!'
    ...
    echo
    echo 'Export to '$primarytargetoutputformat' Starting!'
