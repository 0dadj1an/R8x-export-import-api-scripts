...
#
ScriptVersion=00.19.00
ScriptDate=2017-04-04

#

export APIScriptVersion=v00x19
...
#mgmt_cli add host --batch "$APICLICSVImportpathbase" --ignore-errors true --ignore-warnings true details-level "full" --format json -s $APICLIsessionfile > dump/$DATE/hosts_dump_full_$DATE.txt
#mgmt_cli set network --batch "$APICLICSVImportpathbase" --ignore-errors true --ignore-warnings true details-level "full" --format json -s $APICLIsessionfile > dump/$DATE/hosts_dump_full_$DATE.txt
#
