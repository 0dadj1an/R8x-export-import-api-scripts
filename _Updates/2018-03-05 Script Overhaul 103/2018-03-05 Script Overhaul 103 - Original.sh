...
limit $APICLIObjectLimit offset $currentgroupoffset details-level "standard" -s $APICLIsessionfile --format json | $JQ ".objects[] | '"$systemobjectselector"' | .name | @sh"

details-level "standard" -s $APICLIsessionfile --format json | $JQ ".objects[] | '"$systemobjectselector"' | .name | @sh"

details-level "standard" -s $APICLIsessionfile --format json | $JQ ".objects[] | '"$systemobjectselector"
